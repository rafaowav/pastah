      ...
      {filtered.length === 0 ? (
        <div className="bg-card rounded-3xl p-12 text-center border border-dashed border-border main-container-shadow space-y-4">
          ...
          <div className="space-y-1 max-w-sm mx-auto">
            <h3 className="font-heading font-bold text-base text-foreground">Nenhum item cadastrado</h3>
              ...
              >
                <div>
                  <div className="flex justify-between items-start mb-3">
                    <span className="px-2.5 py-1 rounded-full bg-muted text-foreground text-[11px] font-semibold">
                ...
                <div className="pt-4 border-t border-border space-y-3">
                  <div className="flex justify-between items-baseline">
                    <span className="text-[11px] font-semibold text-muted-foreground uppercase">Preço Base</span>
