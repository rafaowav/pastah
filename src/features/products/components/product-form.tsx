    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
      <div className="bg-card rounded-3xl p-6 sm:p-8 main-container-shadow border border-border/80 space-y-6">
        <div className="flex items-center gap-3 border-b border-muted pb-4">
          ...
          <div>
            <h3 className="font-heading font-bold text-lg text-foreground">Informações do Produto ou Serviço</h3>
            <p className="text-xs text-muted-foreground">Cadastre a descrição e preço padrão para reutilizar em orçamentos</p>
          </div>
        </div>
