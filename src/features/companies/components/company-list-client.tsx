      ...
      {filtered.length === 0 ? (
        <div className="bg-card rounded-3xl p-12 text-center border border-dashed border-border main-container-shadow space-y-4">
          ...
          <div className="space-y-1 max-w-sm mx-auto">
            <h3 className="font-heading font-bold text-base text-foreground">Nenhuma empresa configurada</h3>
            ...
            >
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-11 h-11 rounded-2xl bg-primary text-primary-foreground flex items-center justify-center font-bold text-sm shadow-sm">
                  ...
                  <div className="min-w-0">
                    ...
                    {company.document && (
                      <p className="text-[11px] text-muted-foreground font-mono">CNPJ: {company.document}</p>
                    )}
                  </div>
                </div>
